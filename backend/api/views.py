...
class UsuarioViewSet(ModelViewSet):
    ...
    def me(self, request):
        ...
        if not usuario:
            return Response({'detail': "Perfil de usuário não ecnontrado"}, status=404)
...
class DashboardViewSet(ModelViewSet):
    ...
    def list(self, request, *args, **kwargs):
        ...
        contratos_recentes = (
            ...
            .order_by('-id')[:5]
            .values('id', 'data_inicio', 'data_fim', 'valor', 'imovel_id', 'imovel__titulo', 'locador__nome', 'locatario__nome')
        )  
        return Response(
            {
                'status': {
...
def importar_imoveis(request):
    ...
    try:
        ...
        return Response({'detail': 'Importaçõ concluída com sucesso.'}) 

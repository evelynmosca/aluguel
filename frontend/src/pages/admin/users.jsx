...
export default function Users() {
  ...
  const totalLocadores = usuarios.filter(u => u.tipo === "LOCADOR").length;
  const totalLocatarios = usuarios.filter(u => u.tipo === "LOCATARIO").length;
  const barOptions = {
    responsive: true,
    plugins: {
      legend: {
  ...
  const resultadoPesquisa = lista.length;
  ...
  const chartData = {
    ...
    datasets: [
      {
        label: "Usuários",
        data: [totalLocadores, totalLocatarios],
      ...
      <div className="status">
        ...
        <div className="card">
          ...
          <div className="card__content">
            ...
            <p className="card__value">{totalLocadores}</p>
        ...
        <div className="card">
          ...
          <div className="card__content">
            ...
            <p className="card__value">{totalLocatarios}</p>
